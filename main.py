...
class QUnFrameWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("                      BI     の     上     传     程     序 ")
        self.initLayout()  # 设置框架布局
        self.setMinimumWidth(250)
        self.setMouseTracking(True)  # 设置widget鼠标跟踪
        self.initDrag()  # 设置鼠标跟踪判断默认值
        #--------------------------------------------------------
        with open(STATIC_PATH+'\\main.qss', 'r',encoding='UTF-8') as f:  # 导入QListWidget的qss样式
        ...
        self.main_widget.addWidget(FileUpload.DrawMain())
    ...
    def initTitleLabel(self):
        ...
        self._Ico.setObjectName('title_ico')
        self._Ico.setMinimumWidth(100)
        self._Ico.setMinimumHeight(35)
        png = QPixmap(STATIC_PATH+'\\main_logo.png')
        png = png.scaled(QSize(100,35),Qt.KeepAspectRatio)
        self._Ico.setPixmap(png)
        self._Ico.setScaledContents(True)
        self._Ico.move(10,5)
...
if __name__ == "__main__":
    ...
    app.setStyleSheet(open(STATIC_PATH+'\\main.qss','r',encoding='UTF-8').read())
